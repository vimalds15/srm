      ...
      <Navbar.Collapse id="basic-navbar-nav" className="mt-10">
        <div className='rightHead'>
          <Nav className="mr-auto ">
            <Nav.Link href="#abt-scr"><i className="fas fa-server"></i> About Us</Nav.Link>
          <Nav.Link target='_' href="https://www.srmist.edu.in/Announcements"><i className="fas fa-volume-up"></i> Announcements</Nav.Link>
            ...
            <NavDropdown.Item href="#camlife"><i className="fas fa-university"></i> Campus Life</NavDropdown.Item>
                <NavDropdown.Item  href="#admissions"><i class="fas fa-user-graduate"></i> Admission enquiry</NavDropdown.Item>
            </NavDropdown>
          </Nav>
          </div>
        </Navbar.Collapse>
